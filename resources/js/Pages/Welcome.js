...
export default function Welcome(props) {
    ...
    return (
        <>
            ...
            <div name='home' className='w-full h-screen bg-gray-100'>
                <div className='max-w-[1000px] mx-auto px-5 md:px-8 flex flex-col justify-center h-full'>
                    ...
                    <div data-aos='fade-up' data-aos-duration='800' data-aos-delay='400'>
                        ...
                        <p className='flex items-center text-blue-600 font-bold tracking-tighter leading-relaxed py-3 text-sm lg:text-base max-w-[700px]'>
                            <a target='_blank' href="https://forms.office.com/r/07EQe85aKh">Kuesioner Awal Lulusan</a>
                        </p>
                        <div>
            ...
            <div className="flex items-center fixed inset-x-0 bottom-0 justify-start text-xs xl:text-sm ml-5 md:ml-10 text-gray-800 mb-5 md:mb-10"><span className='mr-1'>Made with 💖 by</span><a target='_blank' href='https://alexsiraitnotes.vercel.app/' className='font-semibold tracking-tight font-sans'>Alex Sirait</a></div>
        </>
    );
}
