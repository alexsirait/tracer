                        ...
                        <div>
                            <form onSubmit={updateHandler}>
                                ...
                                <div className="mb-5">
                                    ...
                                    <Input placeholder={`e.g. 2020`} className='w-full lg:w-96' type='text' name='a4' value={data.a4} handleChange={handleChange}/>
                                ...
                                <div className="mb-5">
                                    ...
                                    <Input placeholder={`e.g. 22`} className='w-full lg:w-96' type='text' name='a6' value={data.a6} handleChange={handleChange}/>
                                ...
                                <div className="mb-5">
                                    ...
                                    <div className='flex items-center gap-x-4' onChange={handleChange} value={data.a7}>
                                        <input className='border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm text-gray-800' type="radio" value="Laki-laki" name="a7" id='a71' defaultChecked={data.a7 === 'Laki-laki' && true} /> <label htmlFor='a71' className='block text-gray-700 text-sm text-md tracking-tight font-sans'>Laki-Laki</label>
                                        <input className='border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm text-gray-800' type="radio" value="Perempuan" name="a7" id='a72' defaultChecked={data.a7 === 'Perempuan' && true} /> <label htmlFor='a72' className='block text-gray-700 text-sm text-md tracking-tight font-sans'>Perempuan</label>
                                    </div>
                                ...
                                <div className="mb-5">
                                    ...
                                    <textarea placeholder='e.g. Kav. Sei Tering Blok B2 No.27' className='w-full lg:w-96 border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm placeholder-gray-400/50' type='text' name='a10' value={data.a10} onChange={handleChange}/>
                                ...
                                <div className="mb-5">
                                    ...
                                    <Input placeholder={`e.g. alexsirait1001@gmail.com`} className='w-full lg:w-96' type='text' name='a11' value={data.a11} handleChange={handleChange}/>
                                ...
                                <div className="mb-5">
                                    ...
                                    <Input placeholder={`e.g. 082172433434`} className='w-full lg:w-96' type='text' name='a12' value={data.a12} handleChange={handleChange}/>
